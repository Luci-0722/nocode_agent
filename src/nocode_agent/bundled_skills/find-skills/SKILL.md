...
3. **GitHub stars** — Check the source repository. A skill from a repo with high stars is generally more reliable.

### Step 5: Install the Skill

Once you've identified a good match, install it:
